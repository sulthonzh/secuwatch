...
const ProjectMonitor_1 = require("../monitor/ProjectMonitor");
...
class MonitorCommand {
    async execute(options = {}) {
        ...
        const monitor = new ProjectMonitor_1.ProjectMonitor(config);
        try {
            if (options.quiet) {
    ...
    async runMonitor(monitor, quiet, options = {}) {
    ...
    async startContinuousMonitoring(monitor, interval) {
